...
//        configuration.set("fs.defaultFS", "fs.s3a");
//        String endPoint = "https://s3.cn-north-1.jdcloud-oss.com";
//        String ak = "A4C4326339D0787E96C40510576A8C69";//线上
//        String sk = "2811B0CCD927736BC62BE14B7E2FD4E5";
//
//        String s3endpoint = "https://s3.us-west-2.amazonaws.com";
//        String s3ak = "AKIAI2MKUKFER4L4BZ4Q";
//        String s3sk = "X2KC26XTJI7ww4QYpUlV/esS0eLHAsdheGvhLUor";
